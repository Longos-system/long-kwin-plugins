...
KWin.Switcher {
    ...
    Window {
        ...
        Rectangle {
            ...
            opacity: windowHelper.compositing ? LongUI.Theme.darkMode ? 0.3 : 0.4 : 1.0

            border.color: LongUI.Theme.darkMode ? "#686868" : "#D9D9D9"
                ...
                delegate: Item {
                    ...
                    ColumnLayout {
                        ...
                        Label {
                            ...
                            color: isCurrent ? LongUI.Theme.highlightedTextColor : LongUI.Theme.textColor
                        }
                    }
                } // GridView.delegate
