...
K_PLUGIN_FACTORY_WITH_JSON(
    LongDecorationFactory,
    "Longos.json",
    registerPlugin<Long::Decoration>(););
...
Decoration::Decoration(QObject *parent, const QVariantList &args)
    ...
    , m_settings(new QSettings(QSettings::UserScope, "longos", "theme"))
...
{
    QSettings settings(QSettings::UserScope, "longos", "theme");
